...
//
//    // 分类后的经历集合
//    private List<Resume> internshipExperiences = new ArrayList<>();//实习
//    private List<Resume> workExperiences = new ArrayList<>();//工作
//    private List<Resume> projectExperiences = new ArrayList<>();//项目
//    private List<Resume> portfolioExperiences = new ArrayList<>();//作品集
//}
