...
//    }
    ...
    @Operation(summary ="获取当前身份 0：游客身份 1：学生 2：校友 3：老师 4：企业 5：学生团队 6：管理员")
    ...
    @Operation(summary ="获取用户的四种身份信息是否通过认证 0:未提交过资料 1：已提交待审核 2：审核不通过 3：审核通过，拥有此身份")
    ...
    @Operation(summary ="获取用户某身份信息是否通过认证 0:未提交过资料 1：已提交待审核 2：审核不通过 3：审核通过，拥有此身份")
    ...
    @Operation(summary ="管理端获取审核身份验证资料")
    ...
    @Operation(summary ="管理端通过审核身份验证资料")
    ...
    @Operation(summary ="管理端不通过审核身份验证资料")
