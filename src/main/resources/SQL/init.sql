...
(
  ...
  AUTO_INCREMENT = 1953817177067618307
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8mb3
  COLLATE = utf8mb3_general_ci COMMENT = '权限表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 6
  CHARACTER SET = utf8mb3
  COLLATE = utf8mb3_general_ci COMMENT = '角色表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8mb3
  COLLATE = utf8mb3_general_ci COMMENT = '角色-权限关联表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb3
  COLLATE = utf8mb3_general_ci COMMENT = '用户-角色关联表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    salary_min         double        null comment '薪水下限（单位K）',
    salary_max         double        null comment '薪水上限（单位K）',
    salary_round       varchar(255)  null comment '年发薪次数',
    ...
    status             tinyint       null comment '状态 0/1 可见/不可见',
    is_deleted         tinyint       null comment '逻辑删除 0/1 未删除/删除',
    category           varchar(255)  null comment '岗位类别',
    label              varchar(255)  null comment '系统打标',
    financing_progress varchar(255)  null comment '融资进度',
    enterprise_scale   varchar(255)  null comment '企业规模',
    industry           varchar(255)  null comment '企业所在行业',
...
(
    ...
    type               varchar(255)  null comment '工作类型 实习 兼职 正职',
    tag                varchar(255)  null comment 'tag',
    status             int           null comment '状态 0/1 可见/不可见',
    is_deleted         int           null comment '逻辑删除 0/1 未删除/删除',
    category           varchar(255)  null comment '岗位类别',
